...
{
    class Site5Migrator : SiteMigrator<Site5>
    {
        public Site5Migrator(ISiteService siteService, ISensorService sensorService, ILogService logService)
        ...
        public override void MigrateLogs(Site5 site)
        {
