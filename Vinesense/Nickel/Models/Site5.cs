namespace Nickel.Models
{
    ...
    [Table("viticulture.site_5")]
    public partial class Site5 : ISensorRecord
    {
        ...
        [Column("S2_Water_Potential_Kpa")]
        public float? S2WaterPotentialKpa { get; set; }
        [Column("S3_Temp")]
        ...
        {
            get { return new[] { S1Moist, S2WaterPotentialKpa, S3Moist, S4Moist, S5Moist }; }
        }
    }
}
